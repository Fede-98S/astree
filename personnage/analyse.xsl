...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:note[@ana='poete']">
        <div class="poete">
            <strong>Poète :</strong>
            <xsl:apply-templates/>
        </div>
    ...
    <xsl:template match="tei:note[@ana='interruption']">
    ...
    <xsl:template match="tei:note[@ana='intercalee']">
        <div class="intercalee">
            <strong>Intercalée :</strong>
            <xsl:apply-templates/>
        </div>
    </xsl:template>
